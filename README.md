# Custom chat certificate setup for [KebsCS/LeagueClientDebugger](https://github.com/KebsCS/LeagueClientDebugger)
...
1. Create a new GitHub repository. Add a README so it's not empty.
